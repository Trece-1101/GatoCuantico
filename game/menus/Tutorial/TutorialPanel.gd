...
var text_one := "Solo puedes observar una caja.\nTienes un tiempo limitado para analizar el escenario y hacerlo.\nEl objetivo es llevar a Schodi, el que elegiste observar, hasta la puerta.\nSin embargo el Schodi no observado va a replicar todos los movimientos del otro y solo podras saber si esta vivo o muerto una vez que ingreses a la puerta con 'tu' Schodi y abras la caja."
